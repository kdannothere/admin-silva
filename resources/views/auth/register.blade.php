                    ...
                    <div class="mb-0 border-0 p-md-5 p-lg-0 p-4">
                        ...
                        <div class="pt-0">
                            <form method="POST" action="{{ route('register') }}"
                                @submit.prevent="submit" class="my-4">
                                @csrf

                                <div class="form-group mb-3">
                                    <label for="name" class="form-label">Name</label>
                                    <input class="form-control" name="name" value="{{ old('name') }}" type="text" required placeholder="Enter your Username">
                                </div>

                                <div class="form-group mb-3">
                                    <label for="email" class="form-label">Email address</label>
                                    <input class="form-control" name="email" value="{{ old('email') }}" type="text" required placeholder="Enter your email">
                                </div>
                                ...
                                <div class="form-group mb-3">
                                    ...
                                    <input class="form-control" name="password_confirmation" type="password" required placeholder="Enter your password again">
                                </div>
